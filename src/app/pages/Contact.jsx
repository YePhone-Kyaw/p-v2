...
const Contact = () => {
  ...
  return (
    <section id='contact'>
      ...
      <form>
        <div className='flex items-center justify-between gap-10 w-[600px]'>
          <label>Name</label>
          <input
           type='text'
           id='name'
           ...
           className="w-full  border border-gray-300 bg-teal rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-teal-400 transition cursor-pointer"
