...
const Contact = () => {
  ...
  return (
    <section id='contact'>
      ...
      <p className='mt-5 text-lg text-gray-500'>Whether you have a question, want to collaborate, want to hire, or just want to say hello, feel free to drop a message!</p>
      </div>
